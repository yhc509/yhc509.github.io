---
title: "Epoch: Unseen Devlog 3 - 전투 프로토타입 재료 채우기"
date: "2026-01-17"
description: "SPUM, 주인공 설정, 전투 애니메이션, 전투 공식까지 전투 프로토타입 재료를 한꺼번에 채운 회차."
categories: []
open: true
type: "devlog"
project: "project-t"
...
이 회차에서 주인공 쪽 설정도 다시 잡았다. 아주 오래전에 `천하`라는 모드를 만들며 굴리다 멈춘 설정이 있었는데, 이번에는 그걸 그대로 복원하기보다 남아 있는 핵심만 가져오기로 했다.
